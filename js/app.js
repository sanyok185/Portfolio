(() => {
    ...
    const myFullPage = new FullPage(document.querySelector("[data-fp]"), "");
    document.getElementById("toHome").addEventListener("click", (function(event) {
        event.preventDefault();
        myFullPage.switchingSection(0);
    }));
    document.getElementById("toAbout").addEventListener("click", (function(event) {
        event.preventDefault();
        myFullPage.switchingSection(1);
    }));
    document.getElementById("toStack").addEventListener("click", (function(event) {
        event.preventDefault();
        myFullPage.switchingSection(2);
    }));
    document.getElementById("toProjects").addEventListener("click", (function(event) {
        event.preventDefault();
        myFullPage.switchingSection(3);
    }));
    document.getElementById("toContact").addEventListener("click", (function(event) {
        event.preventDefault();
        myFullPage.switchingSection(4);
    }));
